...
export const BINAURAL_TEMPLATES: readonly BinauralTemplate[] = [
  ...
  },
  {
    ...
    hzLabel: '5 Hz',
    brainwave: 'theta',
    useCase: 'Relax / decompress',
    effect:
      'Plausible theta setting for calm / decompression. Rounded from 7.83/Φ per the Schumann-golden-ratio math basis (see CSV evidence summary).',
    beatHzMin: 5,
    beatHzMax: 5,
    defaultBeatHz: 5,
    recommendedCarrierHz: DEFAULT_TEMPLATE_CARRIER_HZ,
  ...
  },
  {
    ...
    hzLabel: '6 Hz',
    brainwave: 'theta',
    useCase: 'Meditation / hypnagogic theta',
    effect:
      'Usable-but-moderate evidence for hypnagogic theta (suggestion/imagery). Math basis: 7.83 × Φ ÷ 2 rounded to 6 Hz.',
    beatHzMin: 6,
    beatHzMax: 6,
    defaultBeatHz: 6,
    recommendedCarrierHz: DEFAULT_TEMPLATE_CARRIER_HZ,
  ...
  },
  {
    ...
    hzLabel: '10 Hz',
    brainwave: 'alpha',
    useCase: 'Relaxed focus',
    effect:
      'Good alpha default for relaxed focus — a simple alpha-band target with reasonable EEG-literature support.',
    beatHzMin: 10,
    beatHzMax: 10,
    defaultBeatHz: 10,
    recommendedCarrierHz: DEFAULT_TEMPLATE_CARRIER_HZ,
  ...
  },
  {
    ...
    useCase: 'SMR-style focus',
    effect:
      'SMR-style focus target. Math basis: 7.83 × Φ = 12.67 Hz, rounded to 12.5 Hz for product use (better than the exact 12.67 for readability).',
    beatHzMin: 12.5,
    beatHzMax: 12.5,
    defaultBeatHz: 12.5,
    recommendedCarrierHz: DEFAULT_TEMPLATE_CARRIER_HZ,
