...
Client-only: preferences in `localStorage`, no accounts or backend. See [Part 8 in REBUILD-PLAN.md](REBUILD-PLAN.md#part-8--what-were-not-doing) for explicit out-of-scope items.
